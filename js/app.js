(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            let demoPagesSliderThumb = new core(".demo-pages__slider-thumbs", {
            ...
            new core(".demo-pages__slider", {
                ...
                spaceBetween: 20,
                thumbs: {
                    swiper: demoPagesSliderThumb
                },
                navigation: {
                    prevEl: ".demo-pages__slider .swiper-button-prev",
                    nextEl: ".demo-pages__slider .swiper-button-next"
                },
                on: {}
            });
            new core(".quotes-book__slider ", {
                ...
                pagination: {
                    el: ".quotes-book__slider .swiper-pagination",
                    clickable: true
                },
                on: {}
            });
    ...
    window.addEventListener("scroll", (function() {
        let stickyElement = document.getElementById("sticky-element");
        let lastBlock = document.querySelector(".about-book:last-of-type");
        let scrollPosition = window.pageYOffset || document.documentElement.scrollTop;
        let lastBlockPosition = lastBlock.offsetTop + lastBlock.offsetHeight;
        if (scrollPosition > 0 && scrollPosition < lastBlockPosition - window.innerHeight) stickyElement.classList.add("show"); else stickyElement.classList.remove("show");
    }));
    window["FLS"] = true;
    isWebp();
    showMore();
